...
export class LogicPlayScene {
    ...
    static splitPlane(boxStay, boxFall, change, oldBox, oldoldBox, temp2) {
        if (change === true) {
            if (oldBox.box.getPosition().x > oldoldBox.box.getPosition().x + oldoldBox.box.getLocalScale().x * 0.03 && oldBox.box.getPosition().x < oldoldBox.box.getPosition().x + oldoldBox.box.getLocalScale().x) {
            ...
            else if (oldBox.box.getPosition().x < oldoldBox.box.getPosition().x - oldoldBox.box.getLocalScale().x * 0.03 && oldBox.box.getPosition().x > oldoldBox.box.getPosition().x - oldoldBox.box.getLocalScale().x) {
            ...
            else if (oldBox.box.getPosition().x <= oldoldBox.box.getPosition().x + oldoldBox.box.getLocalScale().x * 0.03 && oldBox.box.getPosition().x >= oldoldBox.box.getPosition().x - oldoldBox.box.getLocalScale().x * 0.03) {
            ...
            if (oldBox.box.getPosition().z > oldoldBox.box.getPosition().z + oldoldBox.box.getLocalScale().z * 0.03 && oldBox.box.getPosition().z < oldoldBox.box.getPosition().z + oldoldBox.box.getLocalScale().z) {
            ...
            else if (oldBox.box.getPosition().z < oldoldBox.box.getPosition().z - oldoldBox.box.getLocalScale().z * 0.03 && oldBox.box.getPosition().z > oldoldBox.box.getPosition().z - oldoldBox.box.getLocalScale().z) {
            ...
            else if (oldBox.box.getPosition().z <= oldoldBox.box.getPosition().z + oldoldBox.box.getLocalScale().z * 0.03 && oldBox.box.getPosition().z >= oldoldBox.box.getPosition().z - oldoldBox.box.getLocalScale().z * 0.03) {
                boxStay.box.setPosition(oldoldBox.box.getPosition().x, oldBox.box.getPosition().y, oldoldBox.box.getPosition().z)
                boxStay.box.setLocalScale(oldoldBox.box.getLocalScale())
                boxFall.destroy()
                boxStay.perfect = true
