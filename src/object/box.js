...
export class Box extends Entity {
    ...
    createMateria() {
        const colors = [
            new pc.Color(1, 0, 0),   // Màu đỏ
            new pc.Color(0, 0, 1),   // Màu xanh
            new pc.Color(0.5, 0, 0.5), // Màu tím
            new pc.Color(1, 1, 0),   // Màu vàng
            new pc.Color(1, 0.5, 0.5), // Màu hồng
            new pc.Color(0.5, 0.25, 0), // Màu nâu
            new pc.Color(0, 0, 0),   // Màu đen
            new pc.Color(1, 1, 1),   // Màu trắng
        ];
        ...
        //     vec3 col = pal(value, vec3(1.0, 0.0, 0.0), vec3(0.0, 0.0, 1.0), vec3(1.0, 0.5, 0.5), vec3(0.0, 0.33, 0.67));
        //     dAlbedo = col;
        // }
        // `
